...
if (FLEDGE_SRC)
	...
	file(GLOB_RECURSE _INCLUDE_PLUGINS_COMMON "${FLEDGE_SRC}/C/plugins/common/*.h")
	file(GLOB_RECURSE _INCLUDE_PLUGINS_FILTER_COMMON "${FLEDGE_SRC}/C/plugins/filter/common/*.h")
	list(APPEND _INCLUDE_LIST ${_INCLUDE_COMMON} ${_INCLUDE_SERVICES} ${_INCLUDE_PLUGINS_COMMON} ${_INCLUDE_PLUGINS_FILTER_COMMON})
